...
uses
  Windows, Messages, Classes, VCL.Graphics, Math, ActiveX, ComObj, ShlObj, VCL.Dialogs,
...
function TExtendMenu.GetCommandString(idCmd: UINT_PTR; uFlags: UINT; pwReserved: PUINT;
  pszName: LPSTR; cchMax: UINT): HResult; stdcall;
begin
  ...
  begin
     StrCopy(pszName, PAnsiChar(GetCaptionByCMDID(idCmd)));
...
function TExtendMenu.HandleMenuMsg(uMsg: UINT; WParam: WPARAM; LParam: LPARAM): HResult; stdcall;
var Ret : LRESULT;
begin
...
function TExtendMenu.HandleMenuMsg2(uMsg: UINT; wParam: WPARAM; lParam: LPARAM;
  var lpResult: LRESULT): HResult; stdcall;
var
